...
public class Test {
	...
	public static void main(String args[]) throws IOException
	{
		...
		positionInfo.process("Positions/pro_1_29_931541535x/1_34_196911813251.txt");
		for(int i = 0; i < positionInfo.skillVector.length - 1; i ++)
			System.out.print(KnowledgeBase.skillList[i] + ",");
		System.out.println();
		for(int i = 0; i < positionInfo.skillVector.length - 1; i ++)
			System.out.print(positionInfo.skillVector[i] + ",");
		System.out.println();
		for(int i = 0; i < positionInfo.skillVector.length - 1; i ++)
		...
		System.out.println();
		for(int i = 0; i < resumeInfo.skillVector.length; i ++)
			System.out.print(resumeInfo.skillVector[i] + ",");
		System.out.println();
		for(int i = 0; i < resumeInfo.skillVector.length; i ++)
